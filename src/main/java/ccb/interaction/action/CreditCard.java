...
public class CreditCard extends InteractionsSubImp {
    private final String Pre = "http://creditcard.ccb.com";
    private final String mUrl = "http://creditcard.ccb.com/cn/creditcard/card_list.html";
    private final String mFUrl = "http://creditcard.ccb.com/webtran/get_crd_info.gsp?table_type=1&card_type=%s&card_prov=1001&card_city=1";
    private final String link = "http://creditcard.ccb.com/cn/creditcard/cards/%s.html";
    ...
    void execute() throws Exception {
        ...
        transData(getJsonData(getTagMap()));
    }
